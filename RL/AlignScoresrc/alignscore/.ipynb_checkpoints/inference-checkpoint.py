...
#                 output_score = result[:,0]### use NLI head OR ALIGN head
               ...
               ### reward score computed by hsw
                coefficent = [1.5, 0.5, 1]
                output_score = []
                for num in range(len(result)):
                    ...
                    random_entropy = -(values[1] * math.log(values[1], 2) + values[2] * math.log(values[2]))
                    output_score.append(high_reward - random_entropy)
                    # print(values)
                    # print(high_reward)
                    # print(random_entropy)
                # print(output_score)
